...
const GROUP_ORDER = [
  ...
  },
  {
    ...
    "keys": [
      ...
      "cost_rates_stale_months",
      "cost_index_stale_months",
      "compute_parcel_cost_fsi_max_plausible",
      "compute_parcel_cost_escalation_min_multiplier",
      "compute_parcel_cost_escalation_fallback_multiplier",
      "compute_parcel_cost_premium_default",
      "compute_parcel_cost_adjustment_factor_default",
      "compute_parcel_cost_min_priceable_area_sqm"
    ]
  },
  {
  ...
  },
  {
    ...
    "keys": [
      ...
      "enrich_heritage_designated_count_collapse_floor",
      "compute_parcel_cost_min_population",
      "compute_parcel_cost_engine_error_max",
  ...
  },
  {
    ...
    "keys": [
      ...
      "geocode_permits_heartbeat_minutes",
      "geocode_permits_lock_timeout_ms",
      ...
      "compute_parcel_cost_heartbeat_minutes",
