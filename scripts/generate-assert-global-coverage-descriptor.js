...
fs.writeFileSync(OUT, `${JSON.stringify(descriptor, null, 2)}\n`, 'utf8');
console.log(`Wrote ${OUT} (${checks.length} checks, ${configLogicVariables.length} logic_variables, ${READ_TABLES.length} read tables)`);
