...
### Test suite (item iii)
- 1323/1338 passed (suite success=false)
...
| P3 | I/O cost adjudication (measured, not gated) | measured | descriptor=41923B notes=8992B checks=10 rows records_meta=1547B (newest post/ capture) |
