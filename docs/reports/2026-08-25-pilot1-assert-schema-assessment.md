...
| # | Scope | Pass | Detail |
|---|---|---|---|
| 1 | assert_schema | PASS | min_migration=41 <= migrations count=242 |
...
| P3 | I/O cost adjudication (measured, not gated) | measured | descriptor=26787B notes=8992B checks=10 rows records_meta=1531B (newest post/ capture) |
