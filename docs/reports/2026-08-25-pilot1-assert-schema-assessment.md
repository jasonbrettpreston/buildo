...
### Test suite (item iii)
- 1212/1212 passed (suite success=true)
...
| P3 | I/O cost adjudication (measured, not gated) | measured | descriptor=38337B notes=8992B checks=10 rows records_meta=1547B (newest post/ capture) |
