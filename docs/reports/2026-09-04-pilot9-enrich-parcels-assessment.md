...
| G7 | 3 | 3 | file=true fences=3 it-count=53 RED-evidence=true |
| G8 | 3 | 3 | missing-invocations=0 stale-fingerprints=0 unexplained-diffs=0 |
| G9 (binary) | PASS | — | heading=true low-confidence-table=true recurring-table=true |
| G4d (fence<=lock) | PASS | — | fences=3 lock-it-count=53 |
...
### Test suite (item iii)
- 825/841 passed (suite success=true)
