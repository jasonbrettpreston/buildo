...
**Score: 13/17** · G9 Reflection: PASS · G4d fence-lock coverage: PASS · G-shape: PASS · **Hard stop: YES (G8)**
...
| 8 | enrich_parcels | PASS | G-4: 47 declared, 3 verdict-affecting, 0 violate on_invalid:fail with no deviations[] cover |
...
| 3 | Tunables externalized | enforced-green | G-4: 47 declared, 3 verdict-affecting, 0 violate on_invalid:fail with no deviations[] cover |
...
| P3 | I/O cost adjudication (measured, not gated) | measured | descriptor=83553B notes=11481B checks=31 rows records_meta=8116B (newest post/ capture) |
