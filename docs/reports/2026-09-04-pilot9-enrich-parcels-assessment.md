...
| P3 | I/O cost adjudication (measured, not gated) | measured | descriptor=66582B notes=9615B checks=24 rows records_meta=5792B (newest post/ capture) |
