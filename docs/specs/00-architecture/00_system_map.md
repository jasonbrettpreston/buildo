...
| 78 | `01-pipeline/78_optimal_lot_configuration.md` | Optimal Lot Configuration | `scripts/load-permits.js`, `scripts/compute-build-norms.js` | — | Phase 1 implemented (Permit-Data Foundation). Phases 2–4 designed, not built. |
