...
| 47 | `01-pipeline/47_pipeline_script_protocol.md` | Pipeline Script Protocol — New Step Authoring Standard | `scripts/[new-script].js`, `scripts/lib/[feature]-shared.js` | `src/tests/[feature].logic.test.ts`, `src/tests/permit-type-class.logic.test.ts`, `src/tests/pipeline-advisory-lock.infra.test.ts` | Done |
...
| 61 | `01-pipeline/61_source_heritage_properties.md` | Toronto Heritage Properties (Ingest + Link) | `scripts/load-heritage.js`, `scripts/enrich-heritage.js`, `scripts/enrich-permits.js`, +8 more | `src/tests/load-heritage.{logic,infra}.test.ts` | Authored (WF1 Genesis -- spec-only deliverable; implementation deferred per §8b) |
| 62 | `01-pipeline/62_source_centreline.md` | Toronto Centreline (Streets) (Ingest + Link) | `scripts/load-centreline.js`, `scripts/enrich-centreline.js`, `scripts/enrich-permits.js`, +8 more | `src/tests/pipeline-advisory-lock.infra.test.ts`, `src/tests/load-centreline.{logic,infra}.test.ts` | Authored (WF1 Genesis — spec-only deliverable; implementation deferred per §8b) |
| 65 | `01-pipeline/65_enrich_parcels.md` | Enrich: Parcel Zoning (Spec 58 WF2) — **v1.0** | `scripts/enrich-parcels.js`, `scripts/lib/zoning-precedence.js`, `scripts/lib/max-build.js`, +7 more | `src/tests/pipeline-advisory-lock.infra.test.ts`, `src/tests/chain.logic.test.ts` | Done |
...
| 78 | `01-pipeline/78_optimal_lot_configuration.md` | Optimal Lot Configuration | `scripts/load-permits.js`, `scripts/compute-build-norms.js` | `src/tests/optimal-config.logic.test.ts` | Phase 1 implemented (Permit-Data Foundation). Phases 2–4 designed, not built. |
