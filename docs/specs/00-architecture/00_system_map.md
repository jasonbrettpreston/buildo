...
| 82 | `01-pipeline/82_crm_assistant_alerts.md` | 82 CRM Assistant & Alerts | `src/app/api/leads/save/route.ts` | `src/tests/tracked-projects.logic.test.ts`, `src/tests/tracked-projects.infra.test.ts` | Done |
