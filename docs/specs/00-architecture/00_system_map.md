...
| 65 | `01-pipeline/65_enrich_parcels.md` | Enrich: Parcel Zoning (Spec 58 WF2) — **v1.0** | `scripts/enrich-parcels.js`, `scripts/lib/zoning-precedence.js`, `scripts/one-time/backfill-parcels-zoning-index.js`, +4 more | `src/tests/pipeline-advisory-lock.infra.test.ts`, `src/tests/chain.logic.test.ts` | Done |
