...
| 84 | `01-pipeline/84_lifecycle_phase_engine.md` | 84 Lifecycle Phase Engine — The "Strangler Fig" Classifier | `src/lib/classification/lifecycle-phase.ts`, `src/lib/leads/build-lifecycle-timeline.ts`, `src/components/FreshnessTimeline.tsx`, +13 more | `src/tests/control-panel.logic.test.ts`, `src/tests/lifecycle-phase.logic.test.ts` | Done |
