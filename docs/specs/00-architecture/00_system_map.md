...
| 44 | `01-pipeline/44_chain_deep_scrapes.md` | Deep Scrapes (AIC Inspection Portal) | `scripts/manifest.json`, `scripts/aic-scraper-nodriver.py`, `scripts/aic-orchestrator.py`, +6 more | `src/tests/db/236_permit_scrape_outcomes.db.test.ts`, `src/tests/db/237_scrape_outcome_prune.db.test.ts` | Done |
