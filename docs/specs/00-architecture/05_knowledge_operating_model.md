...
- **Advisory rule.** New convention announced in CLAUDE.md or a spec but not enforced by lint, type, or test. Within 4 weeks the rule decays into "a thing we used to care about."
