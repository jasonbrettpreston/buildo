...
- **Pass:** a row exists, `completed_at` within the last 25h (daily schedule). The
  ...
  INSERT at `run-chain.js:413` + completion UPDATE at `:542`; S3 fold 2026-07-22 + 2026-08-09 re-correction (chain-budget WF3 insertion drift — this citation class has now drifted twice), corrected
