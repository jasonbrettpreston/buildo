...
- *Key files (as delivered):*
  ...
  - `migrations/138-141` (NOT NULL + UNIQUE promotion on the 4 consumer tables; `tracked_projects` UNIQUE is partial, NOT NULL deferred to Phase F per dual-key consideration)
