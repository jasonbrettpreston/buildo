...
- **UI:** `*.ui.test.tsx` — search idle/loading/empty/results; watchlist bulk-select → delete-confirm (shadcn `AlertDialog`) flow; detail drawer delayed-badge + expected-start prominence; empty state; 768px responsive smoke.
