...
| 41 | `pipeline/41_chain_permits.md` | Permits | `scripts/manifest.json`, `scripts/quality/assert-lifecycle-phase-distribution.js`, `scripts/quality/assert-entity-tracing.js` | `src/tests/chain.logic.test.ts`, `src/tests/pipeline-sdk.logic.test.ts`, `src/tests/quality.infra.test.ts` | Done |
...
| 49 | `pipeline/49_data_completeness_profiling.md` | Global Data Completeness Profile | `scripts/quality/assert-global-coverage.js`, `scripts/manifest.json`, `src/components/FreshnessTimeline.tsx` | `src/tests/assert-global-coverage.infra.test.ts` | Active |
