...
| 28 | `28_data_quality_dashboard.md` | Data Quality Dashboard | `src/lib/quality/metrics.ts`, `src/lib/quality/types.ts`, `src/app/api/quality/route.ts`, +6 more | `src/tests/quality.logic.test.ts`, `src/tests/quality.infra.test.ts` | Done |
